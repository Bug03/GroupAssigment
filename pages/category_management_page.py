...
class CategoryManagementPage():
    ...
    def navigate_to_category_list(self):
        category_btn = self.driver.find_element(By.CSS_SELECTOR,"#app > div > div.main-sidebar.sidebar-style-2 > ul > li:nth-child(6) > a")
        category_btn.click()
        time.sleep(1)
    ...
    def get_category_list(self):
        ...
        category_elements = self.driver.find_elements(By.CSS_SELECTOR, 'table tbody tr td:nth-child(2) span div')
        
        # Trả về danh sách các tên sản phẩm
        return [category.text for category in category_elements]
    ...
    def navigate_to_add_category_page(self):
        account_btn = self.driver.find_element(By.CSS_SELECTOR,"body > div.header.header-sticky > div > div > div > div.col-lg-4.col-md-4.col-sm-5.col-5 > div.general_head_right > ul > li:nth-child(1) > a")
        self.driver.execute_script("arguments[0].scrollIntoView(true);", account_btn )
        account_btn.click()
        time.sleep(1)

        admin_btn = self.driver.find_element(By.CSS_SELECTOR,"body > div.header.header-sticky > div > div > div > div.col-lg-4.col-md-4.col-sm-5.col-5 > div.general_head_right > ul > li:nth-child(1) > div > ul > li:nth-child(2)")
        self.driver.execute_script("arguments[0].scrollIntoView(true);", admin_btn )
        admin_btn.click()
        time.sleep(3)

        category_btn = self.driver.find_element(By.CSS_SELECTOR,"#app > div > div.main-sidebar.sidebar-style-2 > ul > li:nth-child(6) > a")
        self.driver.execute_script("arguments[0].scrollIntoView(true);", category_btn )
        category_btn.click()
        time.sleep(1)
        ...
        self.driver.execute_script("arguments[0].scrollIntoView(true);", add_category_btn )
    ...
    def navigate_to_update_category(self):
        update_btn = self.driver.find_element(By.CSS_SELECTOR,"#app > div > div.main-content > section > div.section-body > div > div > div > div.card-body > div > div.table-responsive.col-md-12 > div > table > tbody > tr:nth-child(4) > td:nth-child(6) > span > div > a.btn.btn-primary")
        update_btn.click()
        time.sleep(1)

    def fill_form_update_category(self, category_name):
        icon_btn = self.driver.find_element(By.CSS_SELECTOR,"#app > div > div.main-content > section > div.section-body > div > div > div > div.card-body > form > div:nth-child(3) > div > button")
        icon_btn.click()
        time.sleep(3)
